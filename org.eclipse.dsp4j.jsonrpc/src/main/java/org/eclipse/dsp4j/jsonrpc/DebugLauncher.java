...
import org.eclipse.dsp4j.jsonrpc.json.DebugMessageJsonHandler;
...
public interface DebugLauncher<T> extends Launcher<T> {
	...
	static <T> DebugLauncher<T> createIoLauncher(Object localService, Class<T> remoteInterface, InputStream in, OutputStream out,
		...
		RemoteEndpoint serverEndpoint = new DebugRemoteEndpoint(outGoingMessageStream, ServiceEndpoints.toEndpoint(localService));
